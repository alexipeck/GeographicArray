...
mod tests {
    ...
    use crate::{
        coordinate_to_index, geographic_array::GeographicArray, normalise_zero_to_one,
        normalised_coordinate_to_index, MAX_RADIUS_METERS,
    };

    use crate::{normalise_negative_one_to_one, Vector};
